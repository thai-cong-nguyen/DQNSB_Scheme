...
class Identity:
    ...
    def isEqual(self, identityobj):
        ...
        """
        return self.IP == identityobj.IP and self.PK == identityobj.PK and self.committee_id == identityobj.committee_id and self.PoW == identityobj.PoW and self.epoch_randomness == identityobj.epoch_randomness and self.partOfNtw == identityobj.partOfNtw and self.port == identityobj.port
...
if __name__ == "__main__":
    try:
        ...
        logging.basicConfig(filename='./src/server/data/thread_elastico_template.log',filemode='w',level=logging.DEBUG)
